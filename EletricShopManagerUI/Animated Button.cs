...
namespace EletricShopManagerUI
{
    public partial class Animated_Button : Button
    {
        ...
        public Animated_Button()
        {
            ...
            MouseOverFrame = new Frame(Properties.Resources.ButtonMouseOver, 25, 0, new Size(100, 30));
            MouseDownFrame = new Frame(Properties.Resources.ButtonMouseDown, 25, 0, new Size(100, 30));
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (!IsMouseOver && !IsMouseDown && MouseOverFrame.CurrentFrame == 0)
            {
                ...
                new Rectangle(new Point(0, 0), MouseOverFrame.FrameSize), GraphicsUnit.Pixel);
            }
